...
// RUN: ($RUN_KERNEL $OUT_FILE.clamped.optimized.ll square 7 "(float,{1.0f,2.0f,3.0f,4.0f,5.0f}):(int,5):(int,10):(float,{0,0,0,0,0}):(int,5)" | 
// RUN:  grep "1.000000,4.000000,9.000000,16.000000,25.000000,0.000000,0.000000,") &&
