...
#define CL_FP_INF_NAN 1 // INF and NaNs are supported. 
#define CL_FP_ROUND_TO_NEAREST 2 // round to nearest even rounding mode supported.
#define CL_FP_ROUND_TO_ZERO 3 // round to zero rounding mode supported.
#define CL_FP_ROUND_TO_INF 4 // round to +ve and -ve infinity rounding modes supported.
#define CP_FP_FMA 5// IEEE754-2008 fused multiply-add is supported. 
